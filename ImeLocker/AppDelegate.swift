...
extension Notification.Name {
    static let killLauncher = Notification.Name("KillImeLockerLauncher")
}
...
private func askForAccessibilityPermission() {
    ...
    alert.messageText = "ImeLocker requires accessibility permissions."
    alert.informativeText = "Please re-launch ImeLocker after you've granted permission in system preferences."
...
class AppDelegate: NSObject, NSApplicationDelegate, NSTableViewDataSource, NSTableViewDelegate {
    ...
    @IBOutlet weak var conditionTableView: TableView! {
        didSet {
            ...
            conditionTableView.register(NSNib(nibNamed: "ImeLocker", bundle: nil), forIdentifier: itemCellIdentifier)
            conditionTableView.register(NSNib(nibNamed: "ImeLocker", bundle: nil), forIdentifier: editCellIdentifier)
        }
    }
